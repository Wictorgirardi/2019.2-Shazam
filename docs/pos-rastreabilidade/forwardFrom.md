...
|Requisito|Descrição|NFR|US|Épicos|Artefato de desenho|
|:--:|:----:|:-------:|:---:|:----:|:----:|
|RNF01 |Disponibilidade de uso em tempo integral|||||
|RNF02 |Acesso para download em Android e IOS|||||
|RNF03 |Necessidade de internet apenas para finalizar buscas|||||
|RNF04 |Curto tempo de busca no banco de dados|||||
|RNF05 |Botão intuitivo e com frases instrutivas|||||
|RNF06 |O aplicativo possuir três telas|||||
|RNF07 |ícones instrutivos na opção  de abrir a mídia musical em um aplicativo reprodutor de músicas|||||
|RNF08 |ícones instrutivos na opção  de compartilhar mídia musical|||||
|RNF09 | Atualização constante do banco de dados ||||| 
|RNF10 | Portabilidades (Dispositivos móveis, Web App) |||||
