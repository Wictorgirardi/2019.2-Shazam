...
| :----: | :--: | :---- | :------ | :-------- |  
| Termo existente em algum contexto específico| Classificação do sujeito<ul><li>Verbo</li><li>Objeto</li><li>Estado</li></ul> |Quem é o sujeito?<ul><li>Quem, quando, quais procedimentos</li><li>Definição</li><li>Significado quando ocorre</li></ul>  | Quais ações executa?<ul><li>Reflexos da ação</li><li>Ações</li><li>Estados decorrentes da ação</li></ul>  | Palavras que se assemelham com os significados das simbologias e auxiliam na compreensão para indivíduos que estão fora do contexto específico |
